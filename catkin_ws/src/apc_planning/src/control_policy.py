...
class controlPolicy():
    ...
    def control_policy(self, back_img_list, binId=0, smirror=False, use_COM=False, use_raw=False):
        #load data
    ...
    def generate_new_images(self, back_image_list, tcp_pose, binId, visualize_score_map = True, smirror = False, use_COM = False, use_raw=False):
        out_dict = {}
        out_dict['images'] = []
        out_dict['images2'] = []
        out_dict['delta_pos'] = []
    ...
    def use_center_patch(self, model, image_list, out_dict):
        ...
        pos_world_0 = convert_image2world([225/2-pos_pixel_img0[1],0]) #np.array([y,-z])
        delta_pos_0 = np.array([0,-pos_world_0[0],0])

        pos_world_1 = convert_image2world([225/2-pos_pixel_img1[1], 0]) #np.array([y,-z])
