...
#
script -q -c "python -m pdb planner17.py -j item_location_file.json -t 'all' -l 5  -d baseline --duration 3600 --without_active_vision -a 'only-grasp-tote' " | tee -a $ARCDATA_BASE/log/planner_log_$time.txt
