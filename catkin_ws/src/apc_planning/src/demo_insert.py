...
#        visualize_grasping_proposals(self.proposal_viz_array_pub, self.all_grasp_proposals, False)
    ...
    def planned_place(self):
        ...
        image_list[0] = crop_contact(self.back_img_list[0], image_list[0], gel_id = 1, is_zeros=use_COM)
        image_list[1] = crop_contact(self.back_img_list[1], image_list[1], gel_id = 2, is_zeros=use_COM)
        ...
        pos_world_avg = np.nan_to_num(pos_world_avg)
