...
def goHomeSuc(robotConfig = None,
            homePos = [1,0,1.2], 
            isExecute = True,
            withPause = False):
    ...
    home_joint_pose = [-0.005744439031, -0.6879946105, 0.5861570764, 0.09693312715, 0.1061231983, -0.1045031463+math.pi]
