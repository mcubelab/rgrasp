...
int EgmCartesian::RequiredFieldsByteSizeFallback() const {
  int total_size = 0;
...
int EgmQuaternion::RequiredFieldsByteSizeFallback() const {
  int total_size = 0;
...
int EgmEuler::RequiredFieldsByteSizeFallback() const {
  int total_size = 0;
...
int EgmPathCorr::RequiredFieldsByteSizeFallback() const {
  int total_size = 0;
