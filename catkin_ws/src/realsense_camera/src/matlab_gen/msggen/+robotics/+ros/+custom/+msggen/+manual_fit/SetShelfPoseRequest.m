classdef SetShelfPoseRequest < robotics.ros.Message
    %SetShelfPoseRequest MATLAB implementation of manual_fit/SetShelfPoseRequest
    ...
    properties (Constant)
        MessageType = 'manual_fit/SetShelfPoseRequest' % The ROS message type
    end
    ...
    methods
        function obj = SetShelfPoseRequest(msg)
            %SetShelfPoseRequest Construct the message object SetShelfPoseRequest
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'SetShelfPoseRequest', 'Pose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.manual_fit.SetShelfPoseRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.manual_fit.SetShelfPoseRequest;
            obj.reload(strObj);
        end
    end
end
