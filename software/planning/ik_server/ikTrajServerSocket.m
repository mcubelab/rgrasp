...
if exist('urdf_path', 'var')
  options.urdf_path = urdf_path;
end
%options.urdf_path = [getenv('APC_BASE'), '/catkin_ws/src/apc_config/models/irb_2600id-8/irb_2600id-8_drake.urdf']; 
%options.urdf_path = [getenv('APC_BASE'), '/catkin_ws/src/apc_config/models/irb_2600id-15/irb_2600id-15_drake.urdf']; 
