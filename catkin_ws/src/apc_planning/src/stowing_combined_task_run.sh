...
script -q -c "python -m pdb planner17.py -j interactive_result.json -t 'all' -l 5  -d baseline --duration 3600 --combined" | tee -a $ARCDATA_BASE/log/planner_log_$time.txt
