...
from ik.helper import get_joints, get_tcp_pose, mat2quat, get_params_yaml, reference_frames, get_object_properties, vision_transform_precise_placing, vision_transform_precise_placing_with_visualization, drop_pose_transform
...
import time
from ik.helper import deleteMarkers, get_picking_params_from_7, plotPickPoints, plotBoxCorners, make_sure_dir_exists, terminate_ros_node, get_hand_frame, get_picking_params_from_12, compose_output
...
def grasp(objInput,
    ...
    if flag==0:
        ...
        if len(objInput)==12:
            ...
            graspPos, hand_X, hand_Y, hand_Z, grasp_width = get_picking_params_from_7(objInput, objId, listener, br)
        ...
        if  grasp_possible:
            #~1. Move to a location above the bin, Rotate gripper to grasp orientation
        ...
        if isExecute and plan_possible and grasp_possible:
            drop_thick=0.005
            rospy.sleep(0.2)
    ...
    #############
        ...
        if rel_pose==None:
            ...
            drop_pose = drop_pose_transform(rel_pose, BoxBody, place_pose, viz_pub)
