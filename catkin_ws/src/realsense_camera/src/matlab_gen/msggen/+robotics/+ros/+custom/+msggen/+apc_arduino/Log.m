classdef Log < robotics.ros.Message
    %Log MATLAB implementation of apc_arduino/Log
    ...
    properties (Constant)
        MessageType = 'apc_arduino/Log' % The ROS message type
    end
    ...
    methods
        function obj = Log(msg)
            %Log Construct the message object Log
        ...
        function set.Level(obj, level)
            ...
            validateattributes(level, {'numeric'}, {'nonempty', 'scalar'}, 'Log', 'Level');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'Log', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.apc_arduino.Log.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.apc_arduino.Log;
            obj.reload(strObj);
        end
    end
end
