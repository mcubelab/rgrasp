...
if useGPU
   ...
   selfKNNSearchGPU_ptx = parallel.gpu.CUDAKernel('SelfKNNSearch.ptx','SelfKNNSearch.cu');
   %global selfKNNSearchGPU_faster_ptx;
   %selfKNNSearchGPU_faster_ptx = parallel.gpu.CUDAKernel('SelfKNNSearch_faster.ptx','SelfKNNSearch_faster.cu');
...
%tcpMsg = '0 add ice_cube_tray';
tcpMsg = 'NULL 0';
%tcpMsg = '0 mv irish_spring_soap';
%tcpMsg = 'HM 0';
...
fprintf('[MATLAB Total] '); toc(totaltstart);
